...
app.use(cors({
    origin: 'http://design-web.pl', // W produkcji zmień na konkretną domenę: 'https://design-web.pl'
    methods: ['GET', 'POST'],
    credentials: true
}));
    ...
    try {
        ...
        if (!name || !email || !message) {
            ...
            return res.status(400).json({
                status: 'error',
                message: 'Brakuje wymaganych pól: imię, email i wiadomość są obowiązkowe'
            });
        }
                            ...
                            <table cellpadding="8" cellspacing="0" border="0" width="100%" style="margin-bottom: 30px;">
                                ...
                                <tr>
                                    <td style="padding: 10px; background-color: #f8f9fa; border-left: 3px solid #667eea;">
                                        ...
                                        <span style="color: #333; font-size: 16px;">${phone || 'Nie podano'}</span>
                                    </td>
                                </tr>
                            </table>
